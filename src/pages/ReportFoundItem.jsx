...
export default function ReportFoundItem() {
  ...
  const [form, setForm] = useState({
    name: '', category: '', location: '', date: '', description: '', keptLocation: '',
  })
  ...
  return (
    <DashboardLayout title="Report Found Item" subtitle="Fill in the details about the found item.">
      <form className="card form-card" onSubmit={handleSubmit}>
        ...
        <div className="form-grid">
          ...
          <div className="field full">
            <label>Where Item Is Kept (Optional)</label>
            <div className="input-wrap">
              <input placeholder="Enter location" value={form.keptLocation} onChange={update('keptLocation')} />
            </div>
          </div>
        ...
        <button type="submit" className="btn btn-secondary btn-block" style={{ marginTop: 6 }} disabled={loading}>
